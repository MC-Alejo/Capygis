...
def actualizar_columnas(instance):
    ...
    nombre_capa = instance.inputCapaAnalisis.currentText()
    ...
    for i in reversed(range(instance.columnLayout.count())):
        instance.columnLayout.itemAt(i).widget().deleteLater()
    ...
    if capa_seleccionada and capa_seleccionada.type() == QgsMapLayerType.VectorLayer:
        ...
        for field in capa.fields():
            ...
            instance.columnLayout.addWidget(checkBox)